...
function seed() {
  ...
  const seedProducts: Omit<Product, "id" | "slug">[] = [
    {
      name: "Tata Bahaar Imidacloprid 17.8% SL",
      category: "Pesticides",
      brand: "Tata Rallis",
      ...
      stock: 120,
      reorderLevel: 20,
      batchNumber: "BH2025-A18",
      expiryDate: isoPlus(540),
      license: "CIB&RC/2024/PEST/1187",
      description: "Systemic insecticide for sucking pests in cotton, paddy, vegetables.",
      usage:
        "Dissolve 1 ml per litre of water. Spray uniformly during early infestation, preferably in evening.",
      safety:
        "Wear gloves and mask. Do not eat or smoke while spraying. Keep away from children and water sources. Toxic to bees — avoid flowering stage.",
      image: "🧪",
      status: "Active",
      supplier: "Rallis Wholesale, Hyderabad",
      cropTags: ["Cotton", "Paddy", "Chilli"],
    },
    {
      ...
      stock: 88,
      reorderLevel: 15,
      batchNumber: "CRM-GR-28C",
      expiryDate: isoPlus(900),
      license: "FCO/AP/2024/F-2241",
      ...
      image: "🌱",
      status: "Active",
      supplier: "Coromandel Depot, Vijayawada",
      cropTags: ["Paddy", "Maize", "Cotton"],
    },
    {
      name: "Mahyco Bt Cotton MRC 7351 BG-II",
      category: "Seeds",
      brand: "Mahyco",
      manufacturer: "Maharashtra Hybrid Seeds",
      price: 950,
      stock: 6,
      reorderLevel: 10,
      batchNumber: "MH-7351-25",
      expiryDate: isoPlus(180),
      license: "SEED/CERT/AP/2024/2210",
      description:
        "High-yielding Bt cotton hybrid with bollworm resistance, suitable for rainfed and irrigated areas.",
      usage:
        "Sow 1 packet per acre with 90x60 cm spacing. Treat seeds with recommended fungicide before sowing.",
      safety: "Genetically modified seed — sow refuge crop as per ICAR guidelines. Do not consume.",
      image: "🌾",
      status: "Active",
      supplier: "Mahyco AP Depot",
      cropTags: ["Cotton"],
    },
    {
      ...
      category: "Implements",
      brand: "Aspee",
      manufacturer: "American Spring & Pressing",
      price: 1850,
      discountPrice: 1699,
      stock: 42,
      reorderLevel: 8,
      batchNumber: "ASP-KS16-A12",
      expiryDate: isoPlus(1800),
      license: "BIS:IS-3756",
      description:
        "Durable 16-litre manual knapsack sprayer with brass nozzle and adjustable strap.",
      usage:
        "Fill up to 16 L. Pump to build pressure, hold trigger and spray evenly. Clean after every use.",
      safety: "Do not over-pressurize. Inspect hose and seals before use. Keep away from children.",
      image: "🛠️",
      status: "Active",
      supplier: "Aspee Distributors",
      cropTags: ["All Crops"],
    },
    {
      name: "UPL Saaf Carbendazim + Mancozeb 75% WP",
      category: "Organic",
      brand: "UPL",
      ...
      stock: 0,
      reorderLevel: 12,
      batchNumber: "UPL-SAAF-24",
      expiryDate: isoPlus(60),
      license: "CIB&RC/2023/PROT/0902",
      description:
        "Broad-spectrum systemic + contact fungicide for blight, sheath blight, rust and leaf spots.",
      usage:
        "Mix 2 g per litre of water and spray on leaves at first symptom. Repeat after 10–14 days.",
      safety:
        "Wear protective clothing, gloves and mask. Wash thoroughly after handling. Do not contaminate water bodies.",
      image: "🛡️",
      status: "Active",
      supplier: "UPL South India",
      cropTags: ["Paddy", "Wheat", "Vegetables"],
    },
    {
      ...
      stock: 240,
      reorderLevel: 50,
      batchNumber: "IFC-UREA-08",
      expiryDate: isoPlus(720),
      license: "FCO/2024/UREA",
      ...
      image: "🌿",
      status: "Active",
      supplier: "IFFCO Cooperative",
      cropTags: ["Paddy", "Wheat"],
    },
    {
      name: "Kaveri Tomato KS-227 Hybrid Seed",
      category: "Seeds",
      brand: "Kaveri",
      ...
      stock: 35,
      reorderLevel: 8,
      batchNumber: "KS-227-T",
      expiryDate: isoPlus(220),
      license: "SEED/CERT/AP/2024/2284",
      description:
        "Determinate tomato hybrid with firm fruits, good shelf life and transport tolerance.",
      usage:
        "Nursery 25 days, transplant 60x45 cm. Drip irrigation recommended. Stake plants at 30 DAT.",
      safety: "Treat seeds with Thiram before sowing. Keep away from rodents.",
      image: "🍅",
      status: "Active",
      supplier: "Kaveri Seeds Hyderabad",
      cropTags: ["Tomato"],
    },
    {
      name: "Battery Operated Cordless Pruner",
      category: "Implements",
      brand: "Stihl",
      manufacturer: "Stihl India",
      price: 8500,
      stock: 14,
      reorderLevel: 5,
      batchNumber: "STL-PR-12V",
      expiryDate: isoPlus(1800),
      license: "BIS:IS-13947",
      description:
        "Lightweight cordless pruner for orchards and vineyards. 30 mm cutting capacity.",
      ...
      image: "✂️",
      status: "Active",
      supplier: "Stihl Authorized Dealer",
      cropTags: ["Mango", "Grapes", "Citrus"],
    },
  ];
...
export function getProductBySlug(slug: string) {
  return read<Product[]>(PROD_KEY, []).find((p) => p.slug === slug);
}
export function getProduct(id: string) {
  return read<Product[]>(PROD_KEY, []).find((p) => p.id === id);
}
...
export function deleteAddress(id: string) {
  write(
    ADDR_KEY,
    read<Address[]>(ADDR_KEY, []).filter((a) => a.id !== id),
  );
  emit("agrikart-addr");
}
...
export const useOrders = (userId?: string) =>
  useStore<Order[]>(ORDERS_KEY, "agrikart-orders", []).filter(
...
export const useTickets = (userId?: string) =>
  useStore<Ticket[]>(TICKETS_KEY, "agrikart-tickets", []).filter(
    (t) => !userId || t.userId === userId,
  );
export function createTicket(
  input: Omit<Ticket, "id" | "status" | "replies" | "createdAt">,
): Ticket {
  const item: Ticket = {
    ...input,
...
export function getSettings(): CompanySettings {
  return read<CompanySettings>(SETTINGS_KEY, {
    name: "AgriKart Fin Tech Pvt Ltd",
    tagline: "",
    gstin: "",
    license: "",
...
export function outOfStock(products: Product[]) {
