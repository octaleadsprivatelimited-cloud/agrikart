...
function seed() {
  ...
  const testimonials: Testimonial[] = [
    {
      id: uid(),
      name: "Ramesh Reddy",
      role: "Paddy Farmer, Guntur",
      rating: 5,
      createdAt: Date.now() - 3 * 86400000,
      quote:
        "Agrikart helped me get my crop loan in just 3 days. The team came to my village and did everything.",
    },
    {
      id: uid(),
      name: "Lakshmi Devi",
    ...
    },
    {
      id: uid(),
      name: "Suresh Kumar",
      role: "Vegetable Farmer, Khammam",
      rating: 4,
      createdAt: Date.now() - 10 * 86400000,
      quote:
        "Drone spraying saved me 4 days of labour. Booking was simple and the pilot was very professional.",
    },
  ];
  ...
  const videos: VideoItem[] = [
    {
      id: uid(),
      title: "How Agrikart helps farmers",
      description: "Quick intro to our services.",
...
export function upsertVideo(
  v: Omit<VideoItem, "id" | "createdAt" | "youtubeId"> & { id?: string },
) {
