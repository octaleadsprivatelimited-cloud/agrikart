    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Add and manage testimonials, gallery photos, YouTube videos and partner logos shown on the
          website.
        </p>
      </div>
...
function TestimonialsPanel() {
  ...
  const start = (t: Testimonial | null) => {
    setEditing(t);
    setOpen(true);
  };
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => start(null)} size="sm">
            ...
            <CardContent className="space-y-2 p-4">
              ...
              <div className="flex gap-0.5">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star
                    key={i}
                    className={`h-3.5 w-3.5 ${i < t.rating ? "fill-yellow-400 text-yellow-400" : "text-muted"}`}
                  />
                ))}
              </div>
...
function TestimonialDialog({
  ...
  const save = () => {
    if (!name.trim() || !quote.trim()) {
      toast.error("Name & quote required");
      return;
    }
...
function GalleryPanel() {
  ...
  const start = (g: GalleryImage | null) => {
    setEditing(g);
    setOpen(true);
  };
          ...
          <Card key={v.id} className="overflow-hidden">
            ...
            <CardContent className="space-y-1 p-3">
              ...
              <div className="flex justify-end gap-1 pt-1">
                <Button size="icon" variant="ghost" onClick={() => start(v)}>
                  <Pencil className="h-4 w-4" />
                </Button>
                <Button
                  size="icon"
          ...
          <Card key={p.id}>
            <CardContent className="space-y-2 p-4 text-center">
              ...
              <div className="flex justify-center gap-1">
                <Button size="icon" variant="ghost" onClick={() => start(p)}>
                  <Pencil className="h-4 w-4" />
                </Button>
                <Button
                  size="icon"
...
function ModalShell({
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4" onClick={onClose}>
      <div
        className="w-full max-w-lg rounded-xl bg-background shadow-xl"
