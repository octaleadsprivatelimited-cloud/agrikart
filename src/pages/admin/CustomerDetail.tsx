        ...
        <CardContent className="p-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-xs">{customer.farmerCode ? (
                <span className="inline-block rounded bg-primary/10 px-2 py-0.5 font-mono font-bold text-primary">Farmer ID: {customer.farmerCode}</span>
              ) : (
                <span className="inline-block rounded bg-muted px-2 py-0.5 font-medium text-muted-foreground">Farmer ID will be issued after approval</span>
              )}</p>
