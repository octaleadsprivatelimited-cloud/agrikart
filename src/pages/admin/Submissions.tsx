    ...
    <div>
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Forms submitted by farmers from the website. Allocate each to a staff member.
          </p>
        </div>
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        <div className="relative min-w-[220px] flex-1">
          ...
          <Input
            placeholder="Search name, mobile, village, district, ID…"
            value={q}
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    <Select
                      value={s.assignedStaffId ?? ""}
                      onValueChange={(v) => handleAssign(s.id, v)}
                    >
                      <SelectTrigger>
                        <SelectValue
                          placeholder={
                            employees.length ? "Choose employee…" : "No employees available"
                          }
                        />
                      </SelectTrigger>
                      <SelectContent>
                    ...
                    {s.assignedStaffName && (
                      <p className="mt-1 text-xs text-muted-foreground">
                        ...
                        <span className="font-medium text-foreground">{s.assignedStaffName}</span>
                      </p>
                    )}
                  </div>
                  <div>
                    ...
                    s.status !== "Rejected" && (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          toast.success("Lead approved — now visible to staff");
                        }}
                      >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <SelectTrigger className="h-9 w-[200px]">
                        <SelectValue
                          placeholder={employees.length ? "Pick employee…" : "No employees"}
                        />
                      </SelectTrigger>
                      <SelectContent>
                        {employees.map((e) => (
