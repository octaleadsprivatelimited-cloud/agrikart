...
const services = [
  {
    ...
    desc: "Precision spraying of pesticides, fungicides & herbicides — uniform coverage with up to 90% less water.",
  },
  {
    Icon: Sprout,
    title: "Nano Fertiliser Spraying",
    desc: "Foliar application of nano urea & nano DAP for faster nutrient uptake and higher yield.",
  },
  {
    Icon: Camera,
    title: "Crop Health Imaging",
    desc: "Aerial multispectral imaging to detect stress, pests & disease before they spread.",
  },
  {
    Icon: Map,
    title: "Field Mapping & Survey",
    desc: "High-resolution field maps for planning, plot demarcation and yield estimation.",
  },
  {
    Icon: Gauge,
    title: "Seed Broadcasting",
    desc: "Drone-based seed and granule spreading for cover crops and large plots.",
  },
  {
    Icon: ShieldCheck,
    title: "Locust & Pest Control",
    desc: "Rapid-response aerial spraying for outbreak control across large acreages.",
  },
];
...
const benefits = [
  { Icon: Clock, title: "10x Faster", desc: "Spray 1 acre in 7–10 minutes vs hours by hand." },
  {
    Icon: Leaf,
    title: "Eco-Friendly",
    desc: "Up to 30% less chemical and 90% less water used per acre.",
  },
  {
    Icon: ShieldCheck,
    title: "Operator Safe",
    desc: "No human exposure to chemicals during spraying.",
  },
  {
    Icon: IndianRupee,
    title: "Cost Effective",
    desc: "Save on labour, water and input costs every season.",
  },
];
...
const pricing = [
  {
    ...
    features: [
      ...
      "Trained DGCA-certified pilot",
      "Standard nozzle setup",
  ...
  },
  {
    ...
    unit: "/ acre",
    features: [
      "Nano nutrient + pesticide spray",
      "Multispectral crop imaging",
      "Digital field map & health report",
      "Priority scheduling & advisory",
    ],
    featured: true,
  },
];
  ...
  return (
    <>
        ...
        <div className="flex flex-col items-start gap-3 rounded-2xl border border-border/60 bg-card p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:p-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Trained pilots, insured operations, transparent per-acre pricing.
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            ...
            <Button asChild variant="outline">
              <Link to="/contact">
                <Phone className="mr-1 h-4 w-4" /> Talk to us
              </Link>
            </Button>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          End-to-end drone services tailored for Indian farms.
        </p>
      ...
      <section className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Final pricing may vary based on crop, terrain and acreage.
        </p>
        <div className="mt-6 grid gap-4 md:grid-cols-2 md:max-w-3xl md:mx-auto">
          {pricing.map((p) => (
            <Card
              key={p.name}
              className={`relative border-border/60 ${p.featured ? "border-primary/60 shadow-elegant" : ""}`}
            >
              {p.featured && (
      ...
      <section className="container mx-auto px-4 pb-8 sm:pb-12">
        <Card className="border-border/60 md:max-w-3xl md:mx-auto">
          <CardContent className="p-5 sm:p-6">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Select a plan below and continue to fill in your farm details.
            </p>
            <RadioGroup
              value={selectedPlan}
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-2">
            <Button asChild size="lg">
              <Link to="/apply">Request Drone Service</Link>
            </Button>
