...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AgriKart Fin — Empowering Indian Farmers" },
      { property: "og:description", content: "Smart agri-services, finance and trade — all in one place." },
